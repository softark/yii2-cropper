        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <div class="pull-left">
                    ...
                    <?php if ($modalOptions['zoomEnabled']): ?>
                        <div class="btn-group">
                            <button type="button" class="btn btn-primary zoom-in"><?= $cropperOptions['icons']['zoom-in'] ?></button>
                            <button type="button" class="btn btn-primary zoom-out"><?= $cropperOptions['icons']['zoom-out'] ?></button>
                        </div>&nbsp;
                    <?php endif ?>
                    <?php if ($modalOptions['rotateEnabled']): ?>
                        <div class="btn-group">
                    ...
                    <?php endif ?>
                    <?php if ($modalOptions['moveEnabled']): ?>
                        <div class="btn-group">
                            <button type="button" class="btn btn-primary move-left"><?= $cropperOptions['icons']['move-left'] ?></button>
                            <button type="button" class="btn btn-primary move-right"><?= $cropperOptions['icons']['move-right'] ?></button>
